...
<div align="center">
    ...
    $consulta = "select ProbID, Titulo,Vistas, Aceptados, Intentos from problema where UserID='".$_SESSION["UserID"]."'";
    ...
    echo "Hay un total de <b>" . mysqli_num_rows($resultado) . "</b> problemas creados por t&acutei<br>";
    ...
    $left = 0;
        ...
        if(isset($_SESSION['UserName'])){
            $consult = "select ProbID from ejecucion where UserName = '" . mysqli_real_escape_string($enlace,$_SESSION['UserName']) . "'AND ProbID='".$row['ProbID']."' AND Estado = 'Accepted'";
            ...
            if(mysqli_num_rows($respuesta) > 0){
                ...
                $consult = "select ProbID from ejecucion where UserName = '" . mysqli_real_escape_string($enlace,$_SESSION['UserName']) . "'AND ProbID='".$row['ProbID']."'";
                $respuesta = mysqli_query($enlace,$consult) or die('Algo anda mal: ' . mysqli_error());
                if(mysqli_num_rows($respuesta) > 0){
